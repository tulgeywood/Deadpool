...
#Installation
When you're ready to install just setup a script in your JSS to run `curl -s bit.ly/1KndHNE | bash & disown`. This pipes the install.sh script directly to bash.
